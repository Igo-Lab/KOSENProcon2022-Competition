...
c_memcpy_src2gpu.argtypes = (_INT16_PP, _INT16_P)

c_resolver = c_resolver_dll.resolver
c_resolver.restype = None
c_resolver.argtypes = (_INT16_P, ctypes.c_int32, _BOOL_P, _INT32_PP)
...
def memcpy_src2gpu(srcs: npt.NDArray[np.int16], src_lens: npt.NDArray[np.uint32]):
    ...
    c_memcpy_src2gpu(srcs_pp, src_lens.ctypes.data_as(_INT16_P))
