...
# ファイルを参照
bkground = tk.PhotoImage(file="haikei.png")

# Labelの作成
hk = tk.Label(root, image=bkground)
hk.pack(fill="x")
...
#取得数指定テキスト
rd=root.register(limit_char)
how = tk.Entry(master=root, width=5, font=("HGP行書体",26),justify="center", validate="key", validatecommand=(rd, "%P"))
